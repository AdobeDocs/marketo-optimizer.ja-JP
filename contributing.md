...
まずイシューを登録してください。 このプロジェクトの既存のコミッターは
...
必要だということです。 [当社の CLA に署名](http://opensource.adobe.com/cla.html)してください。 あなた
...
見つける必要がありました。 [GitHubのプルリクエストドキュメントを読む](https://help.github.com/ja/articles/about-pull-requests/)
...
アドビはコミュニティからのコントリビューションを歓迎しています。 コントリビューターから一歩進んで
