---
title: Adobe Marketo Optimizerのドキュメント
description: Marketo Optimizerの詳細に関するドキュメント – オンボーディング、AIを活用したマーケティングオートメーション、ユーザージャーニー、オーディエンス管理に関する利用可能なリソースをご確認ください。
...
# Adobe Marketo Optimizerのドキュメント

[!DNL Adobe Marketo Optimizer]は、マーケターやビジネス開発担当者がプログラムを計画し、パーソナライズされた人物ジャーニーを編成して、見込み客を選定できるようにする、AIを活用したマーケティングオートメーションソリューションです。 会話型AIを使用して、B2B リードやアカウント向けにAIを活用してパーソナライズされたコンテンツを提供し、マーケティング部門とセールス部門の連携を強化するエンゲージメントを構築、実行します。

## 基本について学ぶ {#basics}

<table style="table-layout:fixed">
  <tr style="border: 0;">
  <td valign="top"><a href="./start/setup-check-list.md"><img src="assets/do-not-localize/setup-teal.svg"  alt="チェックリストを設定"></a> </td>
  <td valign="top"><a href="./home-insights/home-page.md"><img src="assets/do-not-localize/home-page-teal.svg"  alt="ホームページ"></a> </td>
  <td valign="top"><a href="./agents/chat-interface.md"><img src="assets/do-not-localize/coworker-teal.svg"  alt="同僚のチャットインターフェイス"></a> </td>
  <td valign="top"><a href="./marketing/marketing-management.md"><img src="assets/do-not-localize/marketing-hub-teal.svg"  alt="マーケティング活動ハブ"></a> </td>
  <td valign="top"><a href="./content/digital-asset-management.md"><img src="assets/do-not-localize/asset-management-teal.svg"  alt="デジタルアセット管理"></a> </td>
  <tr style="border: 0;">
    <td valign="top">
    <div><strong> セットアップ </strong><br/><br/> マーケティング チームが開始できるように、初期設定と設定を完了します。</div>
    </td>
    <td valign="top">
    <div><strong> ホームページ </strong><br/><br/> ホームページを中心としたアプリケーションで、ナビゲーションの基本を確認します。</div>
    </td>
    <td valign="top">
    <div><strong>同僚</strong><br/><br/>自然言語を使用して、エージェント型AI スキルを使用したプログラムの計画、ジャーニーの構築、オーディエンスの管理、コンテンツの作成を行います。
    </div>
    </td>
    <td valign="top">
    <div><strong> マーケティングハブ </strong><br/><br/> キャンペーンをプログラムに整理し、マルチチャネルコンテンツでカスタマージャーニーを設計し、カスタムトークンでパーソナライズします。</div>
    </td>
    <td valign="top">
    <div><strong> アセット管理</strong><br/><br/>電子メール、テンプレート、ビジュアルフラグメント内で、ローカルおよびMarketo Engageの画像アセットを使用します。</div>
    </td>
  </tr>
  <tr style="border: 0;">
...
[Learn about Sales Qualifier](https://experienceleague.adobe.com/ja/docs/sales-qualifier/using/home){target="_blank"}
:::
...
<table style="table-layout:auto">
  <tr style="border: 0;">
    <td valign="top">
      ...
      <strong>使い始める</strong><br/><a href="./start/setup-check-list.md"> チェックリストの設定</a><br/><a href="./start/user-management.md"> ユーザー管理</a><br/><a href="./start/email-deliverability.md">電子メールの配信品質</a>
    </td>
    <td valign="top">
      <img src="assets/do-not-localize/icon-gen-ai-blue.svg" width="35px" alt="Coworker"><br/>
      <strong>同僚</strong><br/><a href="./agents/chat-interface.md"> チャットインターフェイス </a><br/><a href="./agents/skills.md"> スキル </a><br/><a href="./agents/program-from-brief.md">概要からプログラムを作成</a><br/><a href="./agents/audience-creation.md"> プログラムのオーディエンスを作成</a>
    </td>
    <td valign="top">
      <img src="assets/do-not-localize/icon-paths.svg" width="35px" alt="マーケティング管理"><br/>
      <strong> マーケティング管理</strong><br/><a href="./marketing/programs.md"> プログラム </a><br/><a href="./marketing/person-journeys.md"> ユーザージャーニー</a><br/><a href="./marketing/email-channel.md"> メールチャネル </a><br/><a href="./content/whatsapp-authoring.md">WhatsApp チャネル </a>
    </td>
  </tr>
  <tr style="border: 0;">
    <td valign="top">
      <img src="assets/do-not-localize/icon_audience.svg" width="35px" alt="オーディエンス"><br/>
      <strong> オーディエンス </strong><br/><a href="./audiences/people-lists.md">人物リスト </a><br/><a href="./audiences/event-based-audiences.md"> イベントベースのオーディエンス </a><br/><a href="./audiences/engagement-scores.md"> エンゲージメントスコア </a><br/><a href="./audiences/personas.md">派生ペルソナ </a><br/><a href="./audiences/destinations.md">宛先</a>
    </td>
    <td valign="top">
      <img src="assets/do-not-localize/icon_assets.svg" width="35px" alt="コンテンツ"><br/>
      <strong> コンテンツ </strong><br/><a href="./content/email-authoring.md">電子メールオーサリング </a><br/><a href="./content/templates.md"> テンプレート </a><br/><a href="./content/landing-pages.md"> ランディングページ </a><br/><a href="./content/forms.md">Forms</a><br/><a href="./content/personalization-expressions.md">Personalization</a>
    </td>
    <td valign="top">
      <img src="assets/do-not-localize/icon-configure.svg" width="35px" alt="管理"><br/>
      <strong>管理</strong><br/><a href="./admin/email-channel-configuration.md">電子メール設定</a><br/><a href="./admin/configuration-channels-whatsapp.md">WhatsApp設定</a><br/><a href="./admin/program-types.md"> プログラムの種類</a>
    </td>
  </tr>
</table>
